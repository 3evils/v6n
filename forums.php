...
//=== Will try to put these in order of most hit to make it a bit faster \0/          
 switch($action) {
          ...
          $HTMLOUT .= "<nav aria-label='breadcrumb'>
			<ol class='breadcrumb'>
				<li class='breadcrumb-item active'>
					<a href='forums.php'>" . $INSTALLER09["site_name"] . "</a>
				</li>
			</ol>
		</nav>";
	  ...
	  continue;
          ...
          $HTMLOUT .= "<div class='card'><div class='card-header'>
...
$HTMLOUT .= "<div class='col-sm-12 col-sm-offset-0'>
          <p align='center'>
	  <a class='btn btn-default btn-sm' href='{$INSTALLER09['baseurl']}/forums.php?action=search'><b>{$lang['forum_pg_srch']}</b></a> 
	  <a class='btn btn-default btn-sm' href='{$INSTALLER09['baseurl']}/forums.php?action=viewunread'><b>{$lang['forum_pg_new']}</b></a>
	  <a class='btn btn-default btn-sm' href='{$INSTALLER09['baseurl']}/forums.php?action=getdaily'><b>{$lang['forum_pg_24h']}</b></a>
	  <a class='btn btn-default btn-sm' href='{$INSTALLER09['baseurl']}/forums.php?catchup'><b>{$lang['forum_pg_mark']}</b></a></p>
          </div>";
