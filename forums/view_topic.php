...
$HTMLOUT .= "<div class='row'><div class='card col-sm-12 col-sm-offset-0'>";
...
$arr_mincreate = isset($arr["min_class_create"]) ? $arr["min_class_crete"] : '';
...
$HTMLOUT .= "<a href='forums.php?action=viewunread' class='btn btn-sm'><span>Show New</span></a>&nbsp;";
if ($maypost) {
    $HTMLOUT .= "<a href='forums.php?action=reply&topicid=" . $topicid . "' class='btn btn-sm'><span>New Reply</span></a>&nbsp;";
}
