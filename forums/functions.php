...
";
       ...
       $htmlout.="<a class='btn btn-default btn-sm float-right' href='{$INSTALLER09['baseurl']}/forums.php?action=editforum&amp;forumid=".$forumid."'><i class='fas fa-edit'></i>
		   Edit</a><a class='btn btn-default btn-sm float-right' href='{$INSTALLER09['baseurl']}/forums.php?action=deleteforum&amp;forumid=".$forumid."'><i class='fas fa-eraser'></i>
		   Delete</a>";
        }
