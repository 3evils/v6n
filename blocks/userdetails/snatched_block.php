...
" . ($INSTALLER09['ratio_free'] ? "" : "<td>{$lang['userdetails_downl']}</td>") . "
" . ($INSTALLER09['ratio_free'] ? "" : "<td>{$lang['userdetails_rate']}</td>") . "
...
<td>{$lang['userdetails_s_fin']}</td>
    ...
    while ($arr = mysqli_fetch_assoc($res)) {
        ...
        $htmlout.= "<tbody><tr>
 <td><img src='{$INSTALLER09['pic_base_url']}caticons/{$CURUSER['categorie_icon']}/" . htmlsafechars($arr["catimg"]) . "' alt='" . htmlsafechars($arr["catname"]) . "' width='42' height='42' /></td>
...
if (isset($user_snatches_data) && isset($user_snatches_data_staff))
  ...
  <div class="columns">
    <ul class="accordion" data-accordion data-responsive-accordion-tabs="accordion medium-tabs large-accordion" data-allow-all-closed="true">
  <li class="accordion-item" data-accordion-item>
    <a href="#" class="accordion-title">'. $lang['userdetails_cur_snatched'].' of '.$count_snatched.'</a>
    <div class="accordion-content" data-tab-content >
      $HTMLOUT.= $user_snatches_data;
    </div>
  </li>
  <li class="accordion-item" data-accordion-item>
    <a href="#" class="accordion-title">'.$lang['userdetails_snatched'].' of '.$count_snatched_staff.'</a>
    <div class="accordion-content" data-tab-content>
      $user_snatches_data_staff
    </div>
  </li>
</ul>
  </div>
