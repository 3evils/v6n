...
if(XBT_TRACKER == true) {
	$htmlout.= "
	<a class='btn btn-success btn-sm' data-toggle='collapse' href='#colapseXBT' role='button' aria-expanded='false' aria-controls='colapseXBT'>
      XBT TRACKER
  </a>
...
if(($halfdownload_counter = $mc1->get_value('halfdownload_counter_alerts_')) === false) {
   ...
   $htmlout .="<a class='btn btn-success btn-sm' data-toggle='collapse' href='#colapsefreelech' role='button' aria-expanded='false' aria-controls='colapsefreelech'>Karma Contribution's</a>
	<div class='collapse' id='colapsefreelech'>  
		<div class='card card-body'></b><div class='alert alert-success'>Freeleech&nbsp;[&nbsp;";
            if($freeleech_enabled){
