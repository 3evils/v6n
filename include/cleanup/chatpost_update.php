...
function docleanup($data)
{
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        while ($arr = mysqli_fetch_assoc($res)) {
            ...
            $modcomment = get_date(TIME_NOW, 'DATE', 1) . " - SHoutbox ban Removed By System.\n" . $modcomment;
    ...
    //==End
    if ($queries > 0) write_log("Chatpost clean-------------------- Chatpost cleanup Complete using $queries queries --------------------");
