...
define('MAIN_DIR', ROOT_DIR . 'main' . DIRECTORY_SEPARATOR);
...
//== XBT or PHP announce
if (XBT_TRACKER == true) {
$INSTALLER09['xbt_prefix'] = 'http://u-232.servebeer.com:2710/';  
$INSTALLER09['xbt_suffix'] = '/announce';
$INSTALLER09['announce_urls'][] = 'http://u-232.servebeer.com:2710/';
} else {
$INSTALLER09['announce_urls'] = array();
$INSTALLER09['announce_urls'][] = 'https://u-232.servebeer.com/announce.php';
$INSTALLER09['announce_urls'][] = 'https://u-232.servebeer.com/announce.php';
}
...
$INSTALLER09['site_email'] = 'no-reply@u-232.servebeer.com';
$INSTALLER09['site_name'] = "U232";
