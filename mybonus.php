...
$HTMLOUT .="<div class='card'>
	<div class='card-header'>
		<h3 class='card-title card-success'>{$lang['bonus_success']}</h3>
	</div>".
"<div class='card-body'><img src='{$INSTALLER09['pic_base_url']}/smilies/karma.gif' alt='good_karma' title='{$lang['bonus_goodk']}' /><span class='label label-success'>{$lang['bonus_congrats']}</span>
...
$HTMLOUT .="
	<div class='card'>
		<div class='card-body'><div class='alert alert-success'>{$lang['bonus_congrats']}".format_username($CURUSER) ."{$lang['bonus_3freeslot1']}{$lang['bonus_clickgbs']}<a class='altlink' href='{$INSTALLER09['baseurl']}/mybonus.php'>{$lang['bonus_kbp']}</a>{$lang['bonus_kbpp']}
		</div>
	</div>
</div>";
echo stdhead($CURUSER['username'] . $lang['bonus_user_kmbp'], true, $stdhead) . $HTMLOUT . stdfoot();
...
$HTMLOUT .="<div class='card'>
<div class='card-body'><div class='alert alert-success'>{$lang['bonus_congrats']}".format_username($CURUSER) ." you have got your 100 rep points!
...
$HTMLOUT .="<div class='card'>
<div class='card-body'><div class='alert alert-success'>{$lang['bonus_congrats']}".format_username($CURUSER) ." you have got yourself access to control the site user blocks!
{$lang['bonus_clickgbs']}<a class='altlink' href='{$INSTALLER09['baseurl']}/mybonus.php'>{$lang['bonus_kbp']}</a>{$lang['bonus_kbpp']}</div></div></div>";
echo stdhead($CURUSER['username'] . $lang['bonus_user_kmbp'], true, $stdhead) . $HTMLOUT . stdfoot();
die;
...
$HTMLOUT .="<div class='card'>
<div class='card-body'><div class='alert alert-success'>{$lang['bonus_congrats']}".format_username($CURUSER) ." you have got yourself unlocked bonus moods for use on site!
{$lang['bonus_clickgbs']}<a class='altlink' href='{$INSTALLER09['baseurl']}/mybonus.php'>{$lang['bonus_kbp']}</a>{$lang['bonus_kbpp']}</div></div></div>";
echo stdhead($CURUSER['username'] . $lang['bonus_user_kmbp'] , true, $stdhead) . $HTMLOUT . stdfoot();
die;
...
$HTMLOUT .="<div class='card card-primary'>
<div class='card-header'>Karma Bonus Point's system :</div>";
...
if(($halfdownload_counter = $mc1->get_value('halfdownload_counter')) === false) {
  ...
  $HTMLOUT .="</table></div>
  <div class='card'>
  <div class='card-header'>What the hell are these Karma Bonus points,
...
For every hour that you seed a torrent, you are awarded with 1 Karma Bonus Point... <br />
  ...
  <div class='card-header'>Other things that will get you karma points : </div>
  <div class='card-body'>
  ...
  <div class='card-header'>Some things that will cost you karma points:</div>
  <br />
  <div class='card-body'>
  &#186;&nbsp;Upload credit
  <br />&#186;&nbsp;Custom title
